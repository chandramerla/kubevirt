	...
	Context("[storage-req]", decorators.StorageReq, func() {
		Context("Online VM", func() {
			...
			DescribeTable("[test_id:wink1]Should be able to add and remove and re-add multiple volumes", func(addVolumeFunc addVolumeFunction, removeVolumeFunc removeVolumeFunction, volumeMode k8sv1.PersistentVolumeMode, vmiOnly bool) {
				...
				Entry("[test_id:hotplugfailvamsi1]with VMs", addDVVolumeVM, removeVolumeVM, k8sv1.PersistentVolumeFilesystem, false),
				Entry("[test_id:hotplugfailvamsi2]with VMIs", addDVVolumeVMI, removeVolumeVMI, k8sv1.PersistentVolumeFilesystem, true),
				Entry("[test_id:hotplugfailvamsi3][Serial] with VMs and block", Serial, addDVVolumeVM, removeVolumeVM, k8sv1.PersistentVolumeBlock, false),
			)
